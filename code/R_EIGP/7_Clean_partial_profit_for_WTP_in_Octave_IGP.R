...
rice_wheat_fixed_long_pprof=read.csv("data/maxwell_interpolated_prices/rice_wheat_fixed_long_rented_profit_pt_IGP.csv")
...
rice_wheat_farmer_practice_pprof=read.csv("data/maxwell_interpolated_prices/rice_wheat_farmer_practice_rented_profit_pt_IGP.csv")
...
export(rice_wheat_farmer_practice_rented_pprof_fixedlong,colNames=F,"code/Octave_IGP_PartialProfit/rice_wheat_farmer_practice_fixedlong_rented_pprof_IGP.xlsx")


## Fixed medium --------------------------------
rice_wheat_fixed_medium_pprof=read.csv("data/maxwell_interpolated_prices/rice_wheat_fixed_medium_rented_profit_pt_IGP.csv")
...
export(rice_wheat_fixed_medium_pprof_fixedlong,colNames=F,"code/Octave_IGP_PartialProfit/rice_wheat_fixed_medium_fixedlong_rented_pprof_IGP.xlsx")

## Onset long --------------------
rice_wheat_onset_long_pprof=read.csv("data/maxwell_interpolated_prices/rice_wheat_onset_long_rented_profit_pt_IGP.csv")
...
export(rice_wheat_onset_long_pprof_fixedlong,colNames=F,"code/Octave_IGP_PartialProfit/rice_wheat_onset_long_fixedlong_rented_pprof_IGP.xlsx")

## Onset medium ------------------------
rice_wheat_onset_medium_pprof=read.csv("data/maxwell_interpolated_prices/rice_wheat_onset_medium_rented_profit_pt_IGP.csv")
...
export(rice_wheat_onset_medium_pprof_fixedlong,colNames=F,"code/Octave_IGP_PartialProfit/rice_wheat_onset_medium_fixedlong_rented_pprof_IGP.xlsx")

## Onset long suppl -----------
rice_wheat_onset_long_suppl_pprof=read.csv("data/maxwell_interpolated_prices/rice_wheat_onset_long_suppl_rented_profit_pt_IGP.csv")
...
export(rice_wheat_onset_long_suppl_pprof_fixedlong,colNames=F,"code/Octave_IGP_PartialProfit/rice_wheat_onset_long_suppl_fixedlong_rented_pprof_IGP.xlsx")

## Onset medium suppl ---------------------------------------
rice_wheat_onset_medium_suppl_pprof=read.csv("data/maxwell_interpolated_prices/rice_wheat_onset_medium_suppl_rented_profit_pt_IGP.csv")
...
export(rice_wheat_onset_medium_suppl_pprof_fixedlong,colNames=F,"code/Octave_IGP_PartialProfit/rice_wheat_onset_medium_suppl_fixedlong_rented_pprof_IGP.xlsx")
