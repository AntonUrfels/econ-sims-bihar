...
rice_wheat_fixed_long_rev=dplyr::rename(rice_wheat_fixed_long_rev,ID=X)


rice_wheat_fixed_long_rev$rice_wheat_area=rep(1,17456)
...
rice_wheat_farmer_practice_rev=dplyr::rename(rice_wheat_farmer_practice_rev,ID=X)
...
export(rice_wheat_farmer_practice_rev_fixedlong,colNames=F,"code/Octace_IGP_Revenue/rice_wheat_farmer_practice_fixedlong_rev_s_IGP.xlsx")
...
rice_wheat_fixed_medium_rev=dplyr::rename(rice_wheat_fixed_medium_rev,ID=X)
...
export(rice_wheat_fixed_medium_rev_fixedlong,colNames=F,"code/Octace_IGP_Revenue/rice_wheat_fixed_medium_fixedlong_rev_s_IGP.xlsx")

## Onset long --------------------
rice_wheat_onset_long_rev=read.csv("data/maxwell_interpolated_prices/rice_wheat_onset_long_rev_IGP.csv")

rice_wheat_onset_long_rev$x=NULL
rice_wheat_onset_long_rev$y=NULL

rice_wheat_onset_long_rev[rice_wheat_onset_long_rev < 0] <- NA
rice_wheat_onset_long_rev=dplyr::rename(rice_wheat_onset_long_rev,ID=X)
...
export(rice_wheat_onset_long_rev_fixedlong,colNames=F,"code/Octace_IGP_Revenue/rice_wheat_onset_long_fixedlong_rev_s_IGP.xlsx")
...
rice_wheat_onset_medium_rev=dplyr::rename(rice_wheat_onset_medium_rev,ID=X)
...
export(rice_wheat_onset_medium_rev_fixedlong,colNames=F,"code/Octace_IGP_Revenue/rice_wheat_onset_medium_fixedlong_rev_s_IGP.xlsx")
...
rice_wheat_onset_long_suppl_rev=dplyr::rename(rice_wheat_onset_long_suppl_rev,ID=X)
...
export(rice_wheat_onset_long_suppl_rev_fixedlong,colNames=F,"code/Octace_IGP_Revenue/rice_wheat_onset_long_suppl_fixedlong_rev_s_IGP.xlsx")
...
rice_wheat_onset_medium_suppl_rev=dplyr::rename(rice_wheat_onset_medium_suppl_rev,ID=X)
...
export(rice_wheat_onset_medium_suppl_rev_fixedlong,colNames=F,"code/Octace_IGP_Revenue/rice_wheat_onset_medium_suppl_fixedlong_rev_s_IGP.xlsx")
