...
ggsave("output/figures_IGP_IGP/rice_wheat_farmer_practice_rev_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP_IGP/rice_wheat_fixed_medium_rev_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP_IGP/rice_wheat_onset_long_rev_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP_IGP/rice_wheat_onset_medium_rev_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP_IGP/rice_wheat_onset_long_suppl_rev_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP/rice_wheat_farmer_practice_pprof_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP/rice_wheat_fixed_medium_pprof_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP/rice_wheat_onset_long_prof_IGP.png",dpi=300,width=6.88, height=4.16)
...
png("output/figures_IGP/UpperWTP_riceonsetlong_prof_IGP.png")
UpperWTP_riceonsetlong_prof
dev.off()
...
png("output/figures_IGP/LowerWTP_riceonsetlong_prof_IGP.png")
LowerWTP_riceonsetlong_prof
dev.off()
...
ggsave("output/figures_IGP/rice_wheat_onset_long_suppl_pprof_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP/rice_wheat_onset_medium_pprof_IGP.png",dpi=300,width=6.88, height=4.16)
...
ggsave("output/figures_IGP/rice_wheat_onset_medium_supp_pprof_IGP.png",dpi=300,width=6.88, height=4.16)
