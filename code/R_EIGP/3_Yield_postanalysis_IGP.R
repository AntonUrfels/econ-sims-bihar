...
create_csv <- function(crop,var) {
  ...
  for (i in 1:length(scen)) {
    write.csv(list_df[[i]],paste0("output/",crop,"_",scen[i],"_IGP.csv"))
  }
}
...
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Rice_fixedlong_farmerpractice_c_IGP.csv")
...
m$Riskiness_Comp[m$Riskiness_Comp==-999999]=NA
...
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Rice_fixedlong_fixedmedium_c_IGP.csv")
...
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Rice_fixedlong_onset_long_c_IGP.csv")
...
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Rice_fixedlong_onset_long_suppl_c_IGP.csv")
...
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Rice_fixedlong_onset_medium_c_IGP.csv")
...
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Wheat_fixedlong_farmerpractice__c_IGP.csv")
...
### Fixed long versus fixed medium 
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Wheat_fixedlong_fixedmedium_c_IGP.csv")
...
# Fixed long versus onset medium 
m <- read.csv("data/maxwell_output_fixedLong_IGP/RA_Wheat_fixedlong_onset_medium_c_IGP.csv")
