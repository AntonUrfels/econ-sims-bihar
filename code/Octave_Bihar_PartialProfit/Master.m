...
ndataseq01060216=xlsread('rice_wheat_farmer_practice_fixedlong_rented_pprof.xlsx')
...
clear
ndataseq01060216=xlsread('rice_wheat_fixed_medium_fixedlong_rented_pprof.xlsx')
CreateWTPBoundsbyCell
CreateTableData
...
clear
ndataseq01060216=xlsread('rice_wheat_onset_long_fixedlong_rented_pprof.xlsx')
CreateWTPBoundsbyCell
CreateTableData
...
clear
ndataseq01060216=xlsread('rice_wheat_onset_medium_fixedlong_rented_pprof.xlsx')
CreateWTPBoundsbyCell
CreateTableData
...
clear
ndataseq01060216=xlsread('rice_wheat_onset_long_suppl_fixedlong_rented_pprof.xlsx')
CreateWTPBoundsbyCell
CreateTableData
...
clear
ndataseq01060216=xlsread('rice_wheat_onset_medium_suppl_fixedlong_rented_pprof.xlsx')
CreateWTPBoundsbyCell
CreateTableData
